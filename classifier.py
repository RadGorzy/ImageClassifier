...
def classify_path(imagePath,modelPath):
    ...
    classify(img_array,modelPath)

def classify_test():
    classify_path("/home/radek/Projects/ImageClassifier/data/images/tree1.jpg","/home/radek/Projects/ImageClassifier/data/models/CNN_binary_Map_person_edited_3x3")
